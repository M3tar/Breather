...
以下功能包含在 Breather 0.2.1 中，不包含在 0.2.0 安装包中。可从 Releases 下载对应安装包或从源码构建；下载版功能以对应 Release 说明为准。
...
0.2.1 的像素漫游已完成双屏动画验证；显示器插拔瞬间仍可能短暂停顿，作为后续性能观察项保留。静态配图不代表帧率或能耗测试结果。
...
- **[0.2.1](https://github.com/M3tar/Breather/releases/tag/v0.2.1)** — 新增“此刻留白 / 像素漫游”休息主题、自然色像素恐龙与多屏同步动画；统一真实休息和预览布局，优化主题卡片、缩略图和预览入口。
